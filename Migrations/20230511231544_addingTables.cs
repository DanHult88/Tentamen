    ...
    public partial class addingTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookClubsId = table.Column<int>(type: "int", nullable: false),
                    usersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookClubUser", x => new { x.BookClubsId, x.usersId });
                    table.ForeignKey(
                        name: "FK_BookClubUser_BookClubs_BookClubsId",
                        column: x => x.BookClubsId,
                        principalTable: "BookClubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookClubUser_Users_usersId",
                        column: x => x.usersId,
